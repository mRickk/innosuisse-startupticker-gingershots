    ...
    <Disclosure as="nav" className="bg-gray-800 fixed top-0 w-full">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex items-center justify-between sm:items-center sm:justify-start">
            <div className="flex flex-1 shrink-0 h-16 items-center">
              <img
                alt="Your Company"
                src={startImage}
                className="h-16 w-auto pr-14"
              />
            </div>
